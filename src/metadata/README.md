 ...
 * [polaron.yml](polaron.yml)
     * Determines how your purl.obolibrary.org/obo/polaron/ redirects will be handled
     ...
     * Paste in the contents of [polaron.yml](polaron.yml)
 ...
 * [polaron.md](polaron.md)
     ...
     * Paste in the contents of [polaron.md](polaron.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
